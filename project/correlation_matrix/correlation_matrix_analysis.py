...
def returns_data(years: List[str], time_step: str) -> None:
    ...
    try:
        ...
        data: pd.DataFrame = pickle.load(open(
            f'../data/original_data/original_data_{years[0]}_{years[1]}_step'
        ...
        # Saving data
        correlation_matrix_tools \
            .save_data(returns_df, function_name, years, time_step)
...
def volatility_data(years: List[str], time_step: str, window: str) -> None:
    ...
    try:
        ...
        # Saving data
        correlation_matrix_tools \
            .save_data(std_df, function_name + f'_win_{window}', years,
                       time_step)
